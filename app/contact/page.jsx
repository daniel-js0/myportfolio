...
const Contact = () => {
  ...
  <main>
      <Navbar/>
      <div className=' min-h-screen w-[90%] md:w-[65%] lg:w-[40%] bg-slate-00 mx-auto flex flex-col justify-center'>

        <h1 className={`text-center  mt- text-blue-800 font-sans text-4xl tracking-wider md:text-5xl font-extrabold md:tracking-wide
