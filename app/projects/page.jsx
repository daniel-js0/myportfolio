...
const Projects = () => {
  ...
  <main>
    <Navbar/>
        ...
        <div className='mb-52 relative w-[88%] lg:w-[75%] xl:w-[70%] max-[281px]:h-[34rem] h-[26rem] mt-14  bg-transparent dark:bg-transparet lg:shadow-none dark:shadow shadow-lg shadow-gray-400 mx-auto overflow-hidden lg:rounded-none rounded-md'>
          <div className='absolute w-[100%] h-[100%] xl:w-[50%] xl:end-0 bg-gray-100 bg-opacity-30 backdrop-blur-sm z-10 
           dark:bg-neutral-900 dark:bg-opacity-70 xl:backdrop-blur-[2px]'>
          ...
          <Image  className=' absolute hidden md:flex xl:hidden top-0 h-[100%] w-[100%]  mx-auto' 
                      src='/Todo.png' width={810} height={510} quality={100}/> 
          <Image  className=' absolute md:hidden xl:flex top-0 h-[100%] w-[100%] xl:w-[50%] xl:rounded-xl end-0 z-0 mx-auto' 
                      src='/mobiletodo.png' width={810} height={510} quality={100}/> 
        </div>
