       ...
       <section>
            <div className="flex z-20 justify-between lg:px-16 w-screen h-16 md:h-20 bg-gray-50 dark:bg-neutral-800 dark:bg-opacity-30 dark:backdrop-blur-xl bg-opacity-30 backdrop-blur-xl  fixed top-0">
              ...
              <div className='flex flex-col lg:hidden -mt-0.5 mr-5 ' >
                  ...
                  className='h-12 w-10 md:mt-2 text-gray-5 '       >  <path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8Z"/></svg>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16"
                  className="h-12 w-10 -mt-10 text-gray-5"        >  <path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8Z"/></svg>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16"
                  className="h-12 w-10 -mt-10 text-gray-5"        >  <path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8Z"/></svg>
              </div>
