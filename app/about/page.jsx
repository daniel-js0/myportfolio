          ...
          <div className='lg:flex'>
               ...
               <h1 className={`text-center mt-32 font-sans text-2xl tracking-wider md:text-3xl font-black md:tracking-wide
                ...
                <div className=" w-[100%] mt-7 bg-slate-20 ">
                   <p className={`text-slate-900 dark:text-gray-200  md:text-xl  text-center  delay-300 duration-700 ${isVisible ? 'translate-y-0 opacity-100' : ' translate-y-12 opacity-0'}`} >  I am a seasoned Frontend developer possessing a unique combination of technical expertise and creative ingenuity. Demonstrated proficiency in creating and crafting web applications focused on user needs, yielding tangible business outcomes. Devoted to the field of software engineering and dedicated to finding effective solutions. A team player who excels in fast-paced, 
