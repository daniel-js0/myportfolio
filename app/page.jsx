  ...
  return (
    <main>
     ...
     <div className=" w-[100%] lg:w-[100%] relative overflow-hidden min-h-screen mx-auto pt-6 bg-neutral-50 ">
              ...
              <Link href='/about'>
                 <div className="h-12 w-56 mx-auto  mt-6">
                    <button className="w-56 h-12 flex justify-center rounded-md bg-slate-800 ">
                     <p className="text-white font-semibold my-auto">Discover my journeys</p>
            ...
            <Image className="absolute md:-top-24 md:-start-24 max-[780px]:h-32 max-[780px]:w-32 grayscale
            max-[780px]:-top-10 max-[780px]:-start-14 max-[285px]:hidden" src="/img4.png" alt="side" width={220} height={110} quality={100}/>
            <Image className="absolute -top-20 -end-24 max-[780px]:h-32 max-[780px]:w-32 grayscale
            max-[780px]:-top-10 max-[780px]:-end-12 max-[285px]:hidden" src="/img3.png" alt="side" width={220} height={110} quality={100} />
            <Image className="absolute -bottom-8 -end-12 max-[780px]:h-32 max-[780px]:w-32 grayscale
            max-[780px]:-bottom-14 max-[780px]:-end-6 max-[285px]:hidden" src="/img1.png" alt="side" width={220} height={110} quality={100}/>
            <Image className="absolute -bottom-12 -start-20 max-[780px]:h-32 max-[780px]:w-32 grayscale
